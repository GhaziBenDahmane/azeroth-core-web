...
- Catalog writes verify every requested item ID against the configured world database, cap bundle sizes and quantities, and replace product metadata plus bundle contents in one transaction.
